...
flowchart TD
    ...
    D --> E[LLM Root Cause Synthesis: Gemini 2.0 Flash / 1.5 Flash / Claude / Dynamic Fallback]
...
2. **Multi-LLM Reasoning Engine**: Supports **Google Gemini API** (`gemini-2.0-flash`), **Anthropic Claude**, or dynamic multi-variant fallback synthesis.
...
|---|---|---|
| `GEMINI_API_KEY` | Recommended | Free Google Gemini 2.0 Flash API Key from [aistudio.google.com](https://aistudio.google.com) |
...
- [x] **Multi-LLM & Multi-Variant Engine**: Google Gemini 2.0 Flash (`GEMINI_API_KEY`), Anthropic Claude, and dynamic multi-variant fallback synthesis implemented.
